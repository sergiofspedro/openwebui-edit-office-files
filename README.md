...
Open WebUI Docker image this was caused by v4.0.4 only consulting the legacy
`OPEN_WEBUI_DATA_DIR` env var — which the upstream image does not set —
...
explicitly in the OWUI container env (or the equivalent path for your install).
